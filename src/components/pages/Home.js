  ...
  return (
    <>
      ...
      <Container fluid className="mx-auto">
        <Row
          className="mt-5 d-flex align-content-center justify-content-center"
          style={{ width: "90%" }}
        >
          <Col style={{ color: "white" }} className=" mt-3 " sm={6}>
            ...
            <br />
            <p>
              Information about covid-19 stats in continents and countries
              around the world.
            </p>
          ...
          <Col
            className="mt-3 d-flex align-content-center justify-content-center"
            sm={6}
          >
            <SocialCard
              headline={"Over World"}
        ...
        <Row className="mt-5 d-flex justify-content-center">
          ...
          <Col className="mt-3" sm={6}>
            ...
            <P>
              ...
              of taste. Symptoms may begin one to fourteen days after exposure
              to the virus. At least a third of people who are infected do not
              develop noticeable symptoms. Of those people who develop symptoms
              noticeable enough to be classed as patients, most (81%) develop
              mild to moderate symptoms (up to mild pneumonia), while 14%
              develop severe symptoms (dyspnea, hypoxia, or more than 50% lung
              involvement on imaging), and 5% suffer critical symptoms
              (respiratory failure, shock, or multiorgan dysfunction). Older
              people are at a higher risk of developing severe symptoms. Some
              ...
              Multi-year studies are underway to further investigate the
